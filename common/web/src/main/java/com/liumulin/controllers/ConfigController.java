...
//@RequestMapping("/com.liumulin.config")
//@RestController
...
//    public CommonResult<Long> add(@RequestBody Config com.liumulin.config) {
//        return new CommonResult<>(configService.add(com.liumulin.config));
//    }
//
//    /**
//     * 根据id删除对象
...
//    public CommonResult<Boolean> update(Config com.liumulin.config) {
//        configService.update(com.liumulin.config);
