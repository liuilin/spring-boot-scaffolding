...
//     * @return 通用返回
//     */
//    public CommonResult<?> allExceptionHandler(Throwable ex) {
...
//        log.warn("[missingServletRequestParameterExceptionHandler]", ex);
//        return CommonResult.error(CommonResultCode.BAD_REQUEST.getCode(), String.format("请求参数类型错误:%s", ex.getMessage()));
//    }
//
//    /**
...
//        return CommonResult.error(CommonResultCode.BAD_REQUEST.getCode(), String.format("请求参数不正确:%s", constraintViolation.getMessage()));
//    }
//
////    /**
...
////        return CommonResult.error(CommonResultCode.BAD_REQUEST);
////    }
//
//    /**
...
//        return CommonResult.error(CommonResultCode.NOT_FOUND.getCode(), String.format("请求地址不存在:%s", ex.getRequestURL()));
//    }
//
//    /**
...
//        return CommonResult.error(CommonResultCode.METHOD_NOT_ALLOWED.getCode(), String.format("请求方法不正确:%s", ex.getMessage()));
//    }
//
////    /**
...
//        return CommonResult.error(CommonResultCode.FORBIDDEN);
//    }
//
////    /**
